-- Rename sessions.expires to sessions.expires_at
...
-- Create updated function that returns account details and creates session
...
BEGIN
    ...
    -- Return all data
    RETURN QUERY
    SELECT v_user_id, v_user_name, v_account_id, p_provider, p_provider_username, p_provider_display_name, v_session_id, v_session_expires;
END;
$$;
