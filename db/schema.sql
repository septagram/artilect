...
--
-- Name: get_user_from_login(public.auth_provider, character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_user_from_login(p_provider public.auth_provider, p_provider_user_id character varying, p_provider_username character varying, p_provider_display_name character varying) RETURNS TABLE(id uuid, name character varying)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_user_id uuid;
...
ALTER FUNCTION public.get_user_from_login(p_provider public.auth_provider, p_provider_user_id character varying, p_provider_username character varying, p_provider_display_name character varying) OWNER TO postgres;
